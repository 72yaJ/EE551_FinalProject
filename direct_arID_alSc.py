...
# coding: utf-8
'''
File Name: direct_arID_alSc.py
Edit Time: 20180422 1912

Content:
    match the albumID in di_arID_alID to score from user_album
...
def main():
    ...
    file_ID = dataDir + 'di_arID_alID.txt'
    file_score = dataDir + 'user_album.txt'
    t = strftime('%Y%m%d%H%M', gmtime())
    title = 'di_arID_alSc'+t+'.txt'
