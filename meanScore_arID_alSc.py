...
# coding: utf-8
'''
File Name: meanScore_arID_alSc.py
Edit Time: 20180422 1929

Content:
    get mean score of albums rated in one artist
...
def main():
    ...
    file_in = dataDir + 'di_arID_alSc.txt'
    t = strftime('%Y%m%d%H%M', gmtime())
    title = 'di_arID_alSc_mean'+t+'.txt'
