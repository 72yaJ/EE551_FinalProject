...
# coding: utf-8
'''
File Name: meanScore_UsAl.py
Edit Time: 20180421 1831

Content:
    get mean score of albums rated by one user
...
def main():
    ...
    file_in = dataDir + 'user_album.txt'
    t = strftime('%Y%m%d%H%M', gmtime())
    title = 'di_UsID_alSc_mean'+t+'.txt'
