...
# coding: utf-8
'''
File Name: meanScore_UsAr.py
Edit Time: 20180421 1835

Content:
    get mean score of artists rated by one user
...
def main():
    ...
    file_in = dataDir + 'user_artist.txt'
    t = strftime('%Y%m%d%H%M', gmtime())
    title = 'di_UsID_arSc_mean'+t+'.txt'
