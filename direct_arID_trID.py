...
# coding: utf-8
'''
File Name: direct_arID_trID.py
Edit Time: 20180422 1859

Content:
    get the list of user artistID contains which tracks
    out:
    usrID artistID trackID...
...
def main():
    ...
    file_in2 = dataDir + 'artistID_trackID.txt'
    t = strftime('%Y%m%d%H%M', gmtime())
    title = 'di_arID_trID'+t+'.txt'
    output_file = dataDir + title
    num1 = 3 # position of artistID in testTrack.txt
    num2 = 0 # position of artistID in artistID_trackID.txt
