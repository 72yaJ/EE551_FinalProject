...
# coding: utf-8
'''
File Name: meanScore_arID_trSc.py
Edit Time: 20180422 1944

Content:
    get mean score of tracks rated in one artist
...
def main():
    ...
    file_in = dataDir + 'di_arID_trSc.txt'
    t = strftime('%Y%m%d%H%M', gmtime())
    title = 'di_arID_trSc_mean'+t+'.txt'
